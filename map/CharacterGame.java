...
public class CharacterGame extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		//music = new Music("Music/El Chombo - Dame Tu Cosita feat. Cutty Ranks (Official Video) [Ultra Music].ogg");
		music = new Music("Music/lively-meadow-victory-fanfare.ogg");
