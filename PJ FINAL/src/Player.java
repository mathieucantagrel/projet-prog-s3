...
public class Player {
	...
	public void init() throws SlickException {
		SpriteSheet spriteSheet = new SpriteSheet("resources/character/character.png", 64, 64);
	...
	private float getFuturX(int delta) {
		...
		if(run){
			...
			case 1: futurX = this.x - .2f * delta; break;
			case 3: futurX = this.x + .2f * delta; break;
			}
		}else {
			switch (this.direction) {
	...
	private float getFuturY(int delta) {
		...
		if(run) {
			switch (this.direction) {
				case 0: futurY = this.y - .2f * delta; break;
				case 2: futurY = this.y + .2f * delta; break;
